...
def test_kmeans_compression(results):
    ...
    try:
        ...
        rounded_model_pixel_error = round(float(model_pixel_error), 5)
        rounded_student_pixel_error = round(float(pixel_error), 5)
...
def test_kmeans_classification(results):
    ...
    try:
        ...
        model_accuracy = round(float(model_accuracy), 5)
